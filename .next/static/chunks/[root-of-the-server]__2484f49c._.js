...
const MainScreenWrapper = (param)=>{
    ...
    const [userDetails, setUserDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MainScreenWrapper.useEffect": ()=>{
            ...
            if (savedDetails) {
                ...
                // Check if details are from today (optional - you can modify this logic)
                const savedDate = new Date(parsedDetails.timestamp);
                const today = new Date();
                const isToday = savedDate.toDateString() === today.toDateString();
                if (isToday) {
                    setUserDetails(parsedDetails);
                } else {
                    // Clear old data and show modal
                    localStorage.removeItem('userDetails');
                    setShowModal(true);
                }
            } else {
                // No saved details, show modal
                setShowModal(true);
            }
        }
    }["MainScreenWrapper.useEffect"], []);
...
_s(MainScreenWrapper, "umbxeYWBybga+tky9GN2xktn7m0=");
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: socialLinks.map((social, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                                ...
                                                                className: "w-14 h-14 rounded-2xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-2xl transition-all hover:scale-110 transform ".concat(social.color),
                                                                title: social.name,
...
_s(ContactPage, "jDSM2KW9J1ItjvyoXgyMy4Jhf+8=");
_c = ContactPage;
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/contact.jsx [client] (ecmascript)\" } [client] (ecmascript)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2484f49c._.js.map